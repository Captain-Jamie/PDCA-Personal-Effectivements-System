...
import { getBioClockConfig, saveBioClockConfig, updateFutureRecordsWithBioConfig } from '../services/storage';
...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, onResetToday }) => {
  ...
  const handleSaveBio = async () => {
    ...
    // Explicitly update today and future records to use new config, leaving history untouched
    await updateFutureRecordsWithBioConfig(bioConfig);
